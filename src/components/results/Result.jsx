...
import logo from '../../assets/logo-pedro-1.jpg';
import {
  Button,
  Modal,
  ModalHeader,
...
//import { EditSurvey } from "../updateSurvey/UpdateSurvey";
    ...
    <div className="container vh-100 ">
            ...
            {Array.isArray(recordsToDisplay) &&
              recordsToDisplay.map((item) => (
                <tr key={item.id}>
                  ...
                  ? (<BsCheck2Circle style = {{ width:'30px', height: "30px"}}/>) 
                  : (<VscError style = {{ width:'30px', height: "30px"}}/>)}</td>
      ...
      <div>
        ...
        >
          ...
          src={logo} alt="logo" /> Busqueda por nombre - Survey App</ModalHeader>
          <ModalBody>
          <div className="table-responsive">
        <table className="table table-bordered" style={{ textAlign:"center"}}>
          <thead>
